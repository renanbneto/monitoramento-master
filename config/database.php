    ...
    */
    ...
    'connections' => [
        ...
        'RHPARANA_SIA' => [
            'driver' => 'pgsql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_RHPARANA_SIA_HOST', '127.0.0.1'),
            'port' => env('DB_RHPARANA_SIA_PORT', '5432'),
            'database' => env('DB_RHPARANA_SIA_DATABASE', 'forge'),
            'username' => env('DB_RHPARANA_SIA_USERNAME', 'forge'),
            'password' => env('DB_RHPARANA_SIA_PASSWORD', ''),
            'charset' => 'utf8',
            'prefix' => '',
            'prefix_indexes' => true,
            'schema' => 'public',
        ...
        'auditoria' => [
            ...
            'port' => env('DB_AUDITORIA_PORT', '5432'),
