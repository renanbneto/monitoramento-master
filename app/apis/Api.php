...
class Api {
    ...
    public function get($rota,$dados, $opts = []){
        ...
        if(!isset($options['chamadaSistema'])){
            $dados = array_merge($dados,['topo'=>Session::get('user')->cdopm_meta4_topo,'opm_id'=>Session::get('user')->opm_id,'local_id'=>Session::get('user')->local_id,'rg'=>Session::get('user')->rg ,'user_id' => Session::get('user')->id]);
        }else{
    ...
    public function getRaw($rota,$dados, $opts = []){
        ...
        if(!isset($options['chamadaSistema'])){
            $dados = array_merge($dados,['topo'=>Session::get('user')->cdopm_meta4_topo,'opm_id'=>Session::get('user')->opm_id,'local_id'=>Session::get('user')->local_id,'cpf'=>Session::get('user')->cpf,'rg'=>Session::get('user')->rg ,'user_id' => Session::get('user')->id]);
        }else{
            $dados = array_merge($dados,['chamadaSistema' => env('APP_NAME')]);
        }
