...
use DaveJamesMiller\Breadcrumbs\Facades\Breadcrumbs;
 ...
 @if ($Autorizacao->can(['Administrador','Auditoria']))
     
 <div class="container-fluid">
   <div class="row">
     <div class="col sidebar mt-0 mb-3">
       <h1><i class="fa fa-file" aria-hidden="true"></i> Arquivos de Logs</h1>
          ...
          {{--  -
           ...
           @if(count($files) > 1)
             ...
             <a id="delete-all-log" href="?delall=true{{ ($current_folder) ? '&f=' . \Illuminate\Support\Facades\Crypt::encrypt($current_folder) : '' }}">
               <span class="fa fa-trash-alt"></span> Deletar todos arquivos
             </a>
           @endif --}}
         @endif
       </div>
