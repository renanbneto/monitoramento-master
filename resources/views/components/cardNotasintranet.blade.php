<div class="info-box">
  <span class="info-box-icon">
    <time draggable="true" datetime="2014-09-24" class="date-as-calendar position-pixels">
        <span class="weekday"></span>
        <span class="day"><i class="{{$icon}}"></i></span>
  ...
  <div class="info-box-content">
    <span class="info-box-number">{{$hora}} - {{$local}}</span>
    <span class="info-box-number" style="font-weight: 100;font-size: x-small;">{{$nota}}</span>
  </div>
</div>             
...
.date-as-calendar .month {
  ...
  background: #B11;
  background : linear-gradient(to bottom right, #d6d6d6 0%, black 100%);
  color: white;
}
