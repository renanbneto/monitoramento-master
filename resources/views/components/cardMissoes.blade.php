<div class="info-box">
  ...
  <div class="info-box-content">
    ...
    <span class="info-box-number" style="font-weight: 100;">{{$local}}</span>
    <span class="info-box-number">Apresentação {{$apresentacao}}</span>
  </div>
</div>             
...
.date-as-calendar .month {
  ...
  background: #B11;
  background : linear-gradient(to bottom right, black 0%, #d6d6d6 100%);
  color: white;
}
